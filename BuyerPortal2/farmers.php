            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Mayank</h4>
                        <p class="card-text text-center">Ranchi,Jharkhand<br><br>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Ankit</h4>
                        <p class="card-text text-center">Ranchi, Jharkhand<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:#FFD700;color:black">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">Sonali</h4>
                        <p class="card-text text-center">Ranchi, Jharkhand<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:#FFD700;color:black">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
            ...
            <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
                <div class="card border-dark border" >
                    <div class="card-body ">
                        ...
                        <h4 class="card-subtitle mb-2  text-center">SBU</h4>
                        <p class="card-text text-center">Ranchi, Jharkhand<br><br>
                            <button type="button" class="btn  border-dark border" style="background-color:#FFD700;color:black">View Profile </button>
                        </p>
                        <!-- <a href="#" class="card-link text-center">Card link</a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center">
                    ...
                    <p class="h6">Copy All right Reversed.<a class="text-green ml-2" href="https://www.google.com" target="_blank">Reserved By Mayank, Ankit and Sonali</a></p>
                </div>
                </hr>
            </div>
        </div>
